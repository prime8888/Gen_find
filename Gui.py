import sys
import csv
from func import toggle_all_checkboxes, checkbox_toggled
import requests
from PyQt5.QtWidgets import QApplication, QMainWindow, QTreeWidget, QPushButton, QMenu, QTreeWidgetItem, QVBoxLayout, QWidget, QTextEdit, QHBoxLayout, QLabel, QCheckBox, QFrame, QSizePolicy, QMessageBox
...
class MainWindow(QMainWindow):
    ...
    def start_clicked(self):
        self.thread = FetchThread(self.tax_ids)
        self.thread.dataFetched.connect(self.update_tree)
    ...
    def apply_stylesheet(self):
        stylesheet_path = "C:/Users/reemb/Source/Repos/Gen_find/src/style.qss"
